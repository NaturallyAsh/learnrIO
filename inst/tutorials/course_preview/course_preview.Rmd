...
We recognize the importance of equipping I-O professionals with the necessary tools they need to excel in the workplace. However, many students lack exposure to data analytics tools most commonly used in applied settings, namely, R, a powerful statistical programming language.  
...
<p>
It's an open-source language, which means that it's free to use and has a large community of users who contribute to its development. R is widely used by statisticians, data analysts, and data scientists for tasks such as data manipulation, visualization, modeling, and machine learning.
...
In conclusion, R is a powerful programming language that is specifically designed for statistical computing and graphics. With its large collection of packages and powerful tools for data analysis and visualization, R is a great choice for anyone working with data. RStudio makes it easier to work with R by providing a user-friendly interface and many useful features.  


## Our Vision and Mission
Our vision is to empower both undergraduate and Industrial Organizational Psychology Graduate students with the statistical and analytical skills they need to succeed in the workplace and become valuable scientist-practitioner professionals.  

Our mission is to develop a supplementary interactive course that utilizes the R programming language to enhance the statistical and analytical skills of both undergraduate and graduate students. By bridging the academic-workplace skills gap, we aim to equip all students with the tools they need to excel in their careers, whether it be pursuing further education or entering directly into industry. We believe that providing a strong foundation in statistical and analytical skills at an earlier stage will better prepare them for future studies or career opportunities in Industrial Organizational Psychology field.  



## The Interactive Course
Through our tutorial, learnrIO, students will have the opportunity to learn basic and more advanced statistical procedures commonly found in applied business settings.  
