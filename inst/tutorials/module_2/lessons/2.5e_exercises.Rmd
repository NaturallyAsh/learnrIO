...
//FIXME getting "does not exist in dir" error with data folder
```{r test, exercise = TRUE}
test <- read_csv("data/transform_practice_emp.csv")
```
...
<div class="callout">
**Keep practicing!** 
Remember, the more you code, the more comfortable you'll get with these concepts.
</div>
