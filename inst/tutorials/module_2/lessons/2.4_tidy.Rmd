...
[Placeholder for an image illustrating tidy data] <!-- TODO: add image from github -->
...
In the following example, we have an `employee_data_sep` dataset that includes a column for full names. First, view the dataset in the codeblock:\
