...
```{r non-syntactic, exercise=TRUE, exercise.lines=2, exercise.setup="prepare-janitor"}
...
```{r clean-names, exercise=TRUE, exercise.setup="prepare-janitor"}
...
```{r}
average_salary_by_department_job <- df |> 
