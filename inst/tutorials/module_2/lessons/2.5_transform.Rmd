...
### Introduction
Data transformation is an important part of analyzing data. It involves cleaning, organizing, and improving raw data so that it can be used to make better decisions. In this lesson you'll learn about tibbles and how they can be used to store data. Then, you'll learn about the core principles of `dplyr`, a core package of the Tidyverse, and how to use its functions to transform data. Finally, you'll learn how to join datasets using `dplyr` functions.\


<div class="general-callout">
A helpful cheatsheet for the main packages used this lesson can be found <a href="https://github.com/rstudio/cheatsheets/blob/main/data-transformation.pdf">here</a>.
</div>
