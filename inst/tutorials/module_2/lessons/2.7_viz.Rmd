...
```{r bar-no-theme, exercise.reveal_solution = FALSE}
hr_data |> 
  count(department) |> 
...
In this lesson, we covered the basics of data visualizations with ggplot2 in R for business contexts, specifically focusing on IO psychology and people analytics. We discussed the Grammar of Graphics, built basic and advanced plots, and explored customization options to enhance the appearance of the visualizations. We also worked through two exercises: one involving creating a scatter plot of employee performance ratings based on years of experience, and the other involving a grouped bar chart to display average engagement scores by department.  

Data visualizations play a crucial role in understanding and communicating insights from data. By leveraging ggplot2 and its functionalities, you can create compelling and informative visualizations that aid in decision-making and storytelling.  

To further enhance your skills in data visualizations, I encourage you to explore more advanced features of ggplot2, such as integrating facets, applying themes and customizations, and using additional geoms and aesthetics to create more sophisticated plots.  

Additionally, consider exploring other packages in R, such as plotly, ggplotly, and shiny, which offer interactive and dynamic visualizations that can further engage your audience.  
