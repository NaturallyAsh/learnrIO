...
# emp_data <- readr::read_csv(here::here("inst/extdata/transform_practice_emp.csv"))
# emp_salary_data <- readr::read_csv(here::here("inst/extdata/transform_practice_emp_salary.csv"))
...
## Tidy Data: Exercises {data-progressive=TRUE}
```{r, child="lessons/2.4e_tidy.Rmd"}
...
## Transforming Data {data-progressive=FALSE}
...
## Transforming Data: Exercises {data-progressive=TRUE}
```{r, child="lessons/2.5e_exercises.Rmd"}
...
## Working with Strings and Text Data: Exercises {data-progressive=TRUE}
```{r, child="lessons/2.6e_exercises.Rmd"}
